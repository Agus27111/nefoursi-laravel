        ...
        >
          <div class="pt-12">
            <ul class="bg-white list-disc text-nowrap pl-8 p-3 rounded-xl">
              <li>
                <a href="sejarah.html" class="w-full block pl-2 pr-8 py-1"
                  >Sejarah</a
                >
              </li>
              <li>
                <a href="visimisi.html" class="w-full block pl-2 pr-8 py-1"
                  >Visi & Misi</a
                >
              </li>
              <li>
                <a href="sambutan.html" class="w-full block pl-2 pr-8 py-1"
                  >Sambutan Rektor</a
                >
              </li>
              <li>
                <a href="fasilitas.html" class="w-full block pl-2 pr-8 py-1"
                  >Fasilitas</a
                >
              </li>
            </ul>
